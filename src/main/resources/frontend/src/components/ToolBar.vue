    ...
    <div class="wrap">
      ...
      <header>
        ...
        <nav>
          <ul class="gnb" id="glb">
            <li>
              <a><router-link to="/finding">지점찾기</router-link></a>
            </li>
            <li>
              <a><router-link to="/schedule">스케쥴링</router-link></a>
            </li>
            <!-- 1. 로그인x -->
            ...
            <template v-if="isUserLogin">
              <li>
                <a
                  ><router-link to="/mypage1/:id"
                    >{{ $store.state.pid }}님</router-link
                  ></a
                >
              </li>
